...
import co.vaango.attendance.multibiometric.Features.UpdateStudentInfo.StudentUpdateDialogFragment;
...
public class StudentListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        int syn_status = student.getSync_status();
        if(syn_status==1){
            holder.syncImageView.setImageResource(R.drawable.ok);
        } else {
            holder.syncImageView.setImageResource(R.drawable.sync);
        }
